...
score, which also counts as bowling that day. The page shows your high score,
average, and recent games. There is no
...
functions/
  ...
  api/score.js     POST {score, date?} log a game (verifies that day), DELETE {date, index}
